            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  RegisterCode(),
                  RegisterType(),
                  if (context.watch<ProviderData>().type != null && context.watch<ProviderData>().type != "StatusUP") RegisterName(),
                  if (context.watch<ProviderData>().type != null && context.watch<ProviderData>().type != "StatusUP") RegisterText(),
                  if (context.watch<ProviderData>().type != null) RegisterBGImage(),
                  if (context.watch<ProviderData>().type != null) RegisterCharacterImage(),
                  if (context.watch<ProviderData>().type != null) RegisterBGM(),
                  const SizedBox(
                    height: 10,
                  ),
                  if (context.watch<ProviderData>().type != null) RegisterSE(),
                  const SizedBox(
                    height: 10,
                  ),
                  if (context.watch<ProviderData>().type != null) RegisterVoice(),
                  const SizedBox(
                    height: 10,
                  ),
                  if (context.watch<ProviderData>().type != null && context.watch<ProviderData>().type == "Question") RegisterGotoAndOption(),
                ],
              ),
            ),
          ),
